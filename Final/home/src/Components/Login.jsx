      ...
      <section className="forms-section">
        ...
        <div className="forms">
          <div className={`form-wrapper ${activeForm === 'login' ? 'is-active fade-in' : ''}`}>
            <button type="button" style={{ outline: "none" }} className="switcher" onClick={() => switchForm('login')}>
              Login
          ...
          <div className={`form-wrapper ${activeForm === 'signup' ? 'is-active fade-in' : ''}`}>
            <button type="button" style={{ outline: "none" }} className="switcher" onClick={() => switchForm('signup')}>
              Sign Up
              <span className="underline"></span>
            </button>
